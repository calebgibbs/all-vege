...
<div id="page-setup"> 
	...
	<p>
		To add a recipe you must go into: <?php if( $_SESSION['privilege'] == 'admin'): ?><i class="fa fa-cog"></i> Site Maintenance
		<?php endif; ?><?php if( $_SESSION['privilege'] == 'moderator'): ?><i class="fa fa-cog"></i> Manage Recipes<?php endif; ?>
		which will open the <i>Add a Recipe</i> page. You will then need to add the 
	</p>
